...
def play_rcb4_motion(motion_num, sleep_wait=0):
	...
	try:
		...
		time.sleep(1)
		motion_cmd_str = b"\x07\x0c\x80\x0b\x00\x00\x9e"
...
stop_motion = b"\x09\x00\x02\x00\x00\x00\x10\x83\x9e"
reset_status = b"\x11\x00\x02\x02\x00\x00\x4b\x04\x00\x00\x00\x00\x00\x00\x00\x00\x64"
resume_motion = b"\x09\x00\x02\x00\x00\x00\x13\x83\xa1"
