...
#--------------------------------------
ser = serial.Serial("/dev/rfcomm1", 115200, serial.EIGHTBITS, serial.PARITY_EVEN, serial.STOPBITS_ONE, timeout = 1)	# create and open a serial port
...
print("Initialization", stop_motion)
ser.write(stop_motion)
time.sleep(1)
a = ""
while a == "":
